...
BEGIN
    ...
    --WR('tr�k='||MOVETXT(Trk,chr(position(PL_PIG_CHESS_ENGINE.stOff +Trk.Fra)))||' vlu='||Trk.vlu||' evals='||PL_PIG_CHESS_ENGINE_EVAL.Evals);      
...
BEGIN
  ...
  EvTot := EvTot + PL_PIG_CHESS_ENGINE_EVAL.Evals;
  WR('tr�k='||MOVETXT(Trk,chr(position(PL_PIG_CHESS_ENGINE.stOff+ Trk.Fra)))||'  '||Trk.Fra ||Trk.Til||' vlu='||Trk.vlu||' typ='||Trk.Typ||' evals='||PL_PIG_CHESS_ENGINE_EVAL.Evals||' tot='||EvTot);      
